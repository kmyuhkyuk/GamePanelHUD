...
{
    [BepInPlugin("com.kmyuhkyuk.GamePanelHUDHit", "kmyuhkyuk-GamePanelHUDHit", "2.3.0")]
    ...
    public class GamePanelHUDHitPlugin : BaseUnityPlugin, IUpdate
    {
        ...
        private void Awake()
        {
            ...
            ScreenRect = HUDCore.GamePanlHUDPublic.GetComponent<RectTransform>();
        }
